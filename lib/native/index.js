...
var clientBuilder = function(primaryConfig, secondaryConfig) {
  ...
  connection.connectionParameters = new ConnectionParameters(primaryConfig, secondaryConfig);
  ...
  connection.ssl = connection.connectionParameters.ssl;
