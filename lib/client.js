...
var Client = function(primaryConfig, secondaryConfig) {
  EventEmitter.call(this);

  this.connectionParameters = new ConnectionParameters(primaryConfig, secondaryConfig);
  ...
  this.connection = this.connectionParameters.connection || new Connection({
    stream: this.connectionParameters.stream,
    ssl:    this.connectionParameters.ssl
  });
  this.queryQueue = [];
  this.binary = this.connectionParameters.binary || defaults.binary;
  this.encoding = 'utf8';
  this.processID = null;
  this.secretKey = null;
