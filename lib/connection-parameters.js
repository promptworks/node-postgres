...
var configToObject = function(config) {
  return (typeof config == 'string' ? parse(config) : (config || {}));
};
...
var ConnectionParameters = function(primaryConfig, secondaryConfig) {
  var config = extend(configToObject(primaryConfig), configToObject(secondaryConfig));
  extend(this, config);
